...
```{r}
bats_raw <- read.csv("./data/bats-raw/Movement coordination in trawling bats (data from Giuggioli et al. 2015).csv")
...
- https://twitter.com/mitchoharawild/status/1108913366100119553
