...
Random forests are commonly used machine learning models for prediction problems. However, the ability to explain a prediction produced by a random forest is limited. We present a visualization method for explaining predictions made by a random forest that identifies key tree structures in the model.
